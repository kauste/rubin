@extends('layouts.app')
@section('content')
<div class="container col-12 col-sm-10 col-xl-8 mt-2 d-flex flex-column justify-content-center">
    ...
    <div class="row mt-5">
        <div class="card border-danger mb-3 m-sm-3 p-3">
            ...
            <div class="card-body text-body">
                ...
                <div class="d-flex justify-content-center flex-column flex-lg-row gap-5">
                    <div class="card col-12 col-lg-5">
                        ...
                        <div class="card-body text-body">
                            <ul class="task-list">
                                ...
                                <li>View, creation, editing and deletion of <b>master</b> <span><i>name, surname, last name, salon where he works (from the list in point 1)</i></span>. The ability to see the assessment of the master.</li>
